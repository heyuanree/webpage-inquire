    ...
    <div id="content">
        ...
        <div class="sbox">
            <div class="stitle simg1">
              <table class=table width="100%" cellspacing="0" cellpadding="0" border="0" bordercolor="#A2C6D3">
                <tr>
            ...
            <div class="scontent">
                <div class="center">
                    <form id="s" name="s" method="get" action="/search_phone.php" onsubmit="return formcheck_url();">
                        请输入您要查询的手机号：
                        <input class="input" name="search" id="str" value="<?php echo $text['number'];?>" size="60" type="text">
                ...
                <div class="box_l f_left">
                    <table class="tables" width="100%" cellspacing="0" cellpadding="0" bordercolor="#A2C6D3" border="1" bgcolor="#E5F2FA">
                        ...
                        <tr id="s_beians">
                            <td align="right" height="25">归属地：</td>
                            <td class="bgFFF"><div style="float:left;" class="loading" id="s_domain">
                                <h3><?php echo $text['place_belong_to'];?></h3>
                                </div>
                              </td>
                        </tr>
                        <tr id="s_titles">
                            <td align="right" height="30">号码段：</td>
                            <td class="bgFFF"><div class="loading" id="s_title"><?php echo $text['number_segment']?></div></td>
                        </tr>
                        <tr id="s_descriptions">
                            <td align="right" height="30">卡类型：</td>
                            <td class="bgFFF"><div class="loading" id="s_description"><?php echo $text['card_type'];?></div></td>
                        </tr>
                        <tr id="s_keywordss">
                            <td align="right" height="30">运营商：</td>
                            <td class="bgFFF"><div class="loading" id="s_keywords"><?php echo $text['ISP'];?></div></td>
                        </tr>
                        <tr id='s_history'>
                            <td align="right" height="30">内置卡：</td>
                            <td class="bgFFF"><div class="loading" id="s_history"><?php echo $text['card_inside']?></div></td>
                        </tr>
                        <tr id="s_keywordss">
                            <td align="right" height="30">通信标准：</td>
                            <td class="bgFFF"><div class="loading" id="s_keywords"><?php echo $text['communication_standard']?></div></td>
                        </tr>
                        <!--
                        <tr id="s_beians">
